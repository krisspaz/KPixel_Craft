// Aquí está tu componente Portfolio con acentos morados eléctricos aplicados
// en títulos, badges, íconos clave y efectos hover, manteniendo el diseño limpio.
...
const projects = [
  {
    ...
    category: "Frontend",
    description:
      "Panel administrativo para visualización de datos de pequeñas y medianas empresas.",
  ...
  },
  {
    ...
    category: "Automation",
    description:
      "Script para generación automática de reportes de ventas y análisis financiero.",
  ...
  },
  {
    ...
    category: "Backend",
    description:
      "Sistema RESTful escalable con autenticación y manejo de bases de datos.",
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-muted-foreground animate-fade-up delay-150">
              Una selección de mis trabajos más recientes, enfocados en automatización,
              análisis de datos y desarrollo web.
            </p>
          </div>
