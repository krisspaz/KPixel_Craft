    ...
    <section id="contacto" className="py-32 relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 text-accent text-xs font-medium mb-6 border border-accent/20 animate-fade-up">
            ...
            <div className="flex gap-4 justify-center lg:justify-start pt-2">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-border bg-card flex items-center justify-center text-muted-foreground hover:border-accent hover:text-accent hover:bg-accent/10 transition-all duration-300"
